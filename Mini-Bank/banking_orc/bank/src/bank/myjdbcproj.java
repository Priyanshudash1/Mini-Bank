	        ...
	        try (Connection con = DriverManager.getConnection(url, user, password);
	        	...
	        	do {
	        		...
	        		case 3:
	        			...
	        			System.out.println("Enter a cust_no for deletion: ");
	        			String cust = sc.nextLine();
	        			String deleteStmt = "DELETE FROM customer WHERE cust_no = ?";
	        			PreparedStatement preparedStatement = con.prepareStatement(deleteStmt);
	        			preparedStatement.setString(1, cust);
	        		...
	        		case 6:
	        			...
	        			// Counter to count the number of rows affected
	        			int rowCount = 0;
